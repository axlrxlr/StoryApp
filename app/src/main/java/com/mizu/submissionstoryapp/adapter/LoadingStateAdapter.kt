...
import com.mizu.submissionstoryapp.databinding.LoadingItemBinding
...
class LoadingStateAdapter(private val retry: () -> Unit) : LoadStateAdapter<LoadingStateAdapter.LoadingStateViewHolder>() {
    ...
    class LoadingStateViewHolder(private val binding: LoadingItemBinding, retry: () -> Unit) :
        ...
        init {
            binding.btnRefreshLoad.setOnClickListener { retry.invoke() }
        }
        fun bind(loadState: LoadState) {
            ...
            binding.btnRefreshLoad.isVisible = loadState is LoadState.Error
